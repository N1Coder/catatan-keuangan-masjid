...
<template>
  <article
    class="shadow-sharp-lg border-4 border-black grid grid-cols-1 lg:grid-cols-2 bg-amber-400 dark:bg-slate-900 p-4 lg:p-6 gap-4"
  >
    <h2
      class="capitalize text-xl lg:text-2xl font-semibold text-white dark:text-slate-200 lg:col-span-2"
    >
    ...
    >
      <h2
        class="capitalize text-md lg:text-lg lg:mb-4 font-semibold mb-1 dark:text-slate-200"
      >
      ...
      >
        ...
        <p
          class="mt-2 text-sm lg:text-base text-rose-700 dark:text-rose-500 font-semibold"
        >
          Rp.
          {{
    ...
    >
      ...
      >
        ...
        <p
          class="mt-2 text-sm lg:text-base text-emerald-700 dark:text-emerald-500 font-semibold"
        >
          Rp.
